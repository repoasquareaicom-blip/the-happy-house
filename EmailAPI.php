...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    /*if (mail($to, $subject, $message, $headers)) {
        ...
        //logEmail('reach', $input['recipient'], $input['subject'], $input['message'], $response['message']);
    ...
    $mail->addAddress($input['recipient'], 'Recipient Name');
    ...
    $mail->addEmbeddedImage($imagePath, $cid, 'The-Happy-House-Logo.png');

    // Email body with embedded image
   
    /* $message = "
        <h1>Hello!</h1>
        <p>Your One-Time Password (OTP) for login is: <strong style='font-size: 1.2em;'>{{otp}}</strong></p>
        <p>This is a test email from The Happy House.</p>
   ...
   */
    ...
    $message = str_replace("alt='The Happy House Logo'", "src='cid:$cid' alt='The Happy House Logo' alt='The Happy House Logo'", $message);
    $mail->Body = $message;
