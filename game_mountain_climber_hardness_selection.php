...
<head>
    ...
    <title>Mountain Climber - Difficulty</title>
    <style>
        :root {
...
<body>
    ...
    <div id="scaler-container">
        <div class="selection-wrapper">
            <div class="game-title">Mountain Climber</div>
    ...
    <script>
        ...
        document.querySelectorAll('.complexity-button').forEach(button => {
            button.addEventListener('click', () => {
                ...
                window.location.href = "game_mountain_climber.php";
            });
        });
