...
<head>
    ...
    <title>Find My Robot - Difficulty</title>
    <style>
        :root {
...
<body>
    ...
    <div id="scaler-container">
        <div class="selection-wrapper">
            <div class="game-title">Find My Robot</div>
    ...
    <script>
        ...
        document.querySelectorAll('.complexity-button').forEach(button => {
            button.addEventListener('click', () => {
                ...
                window.location.href = "game_find_my_robot_build_robot.php";
            });
        });
